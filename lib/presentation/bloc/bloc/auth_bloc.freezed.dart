...
/// @nodoc
abstract class _$$_AuthCopyWith<$Res> implements $AuthEventCopyWith<$Res> {
...
class _$_Auth implements _Auth {
  const _$_Auth({required this.email, required this.password});
  ...
  @override
  String toString() {
    return 'AuthEvent.auth(email: $email, password: $password)';
  }
...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(UserInfoModel model) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(UserInfoModel model)? success,
...
class _$_Success implements _Success {
  ...
  @override
  String toString() {
    return 'AuthState.success(model: $model)';
  }
...
abstract class _Success implements AuthState {
  const factory _Success({required final UserInfoModel model}) = _$_Success;

  UserInfoModel get model;
  @JsonKey(ignore: true)
  _$$_SuccessCopyWith<_$_Success> get copyWith =>
      throw _privateConstructorUsedError;
}
